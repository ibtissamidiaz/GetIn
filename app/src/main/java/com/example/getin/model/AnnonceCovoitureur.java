...
public class AnnonceCovoitureur extends Annonce {
    ...
    public AnnonceCovoitureur(long annonce_id, String heure_depart, String heure_arrivee, String point_depart, String point_arrivee, String description, long utilisateur_id, int nbr_personnes, double prix) {
